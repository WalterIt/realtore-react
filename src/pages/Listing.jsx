  ...
  return (
    <main>
      ...
      <div
        ...
        className="fixed top-[13%] right-[3%] z-10 bg-white cursor-pointer border-2 border-gray-400 rounded-full w-12 h-12 flex items-center justify-center"
      >
      ...
      <div className="m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5">
        <div className="w-full">
          ...
          <ul className="flex items-center gap-8 text-sm font-semibold mb-6">
        ...
        <div className="w-full h-[300px] md:h-[400px] md:ml-2 z-10 overflow-x-hidden">
          <MapContainer
